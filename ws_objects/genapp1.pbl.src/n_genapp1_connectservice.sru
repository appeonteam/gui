$PBExportHeader$n_genapp1_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_genapp1_connectservice from nonvisualobject
end type
end forward

global type n_genapp1_connectservice from nonvisualobject
end type
global n_genapp1_connectservice n_genapp1_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "E:\源码功能测试__SVN&Git\测试案例\gui\genapp1.ini"
...
on n_genapp1_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_genapp1_connectservice.destroy
